// The contract below represents a very simple game: whoever sends 
// it an amount of ether that is larger than the current prize becomes
//  the new king. On such an event, the overthrown king gets paid the new prize,
